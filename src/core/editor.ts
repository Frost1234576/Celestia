...
const getProjectPath = () => useProjectStore.getState().projectPath;
...
export const useEditorStore = create<EditorState>((set, get) => ({
  ...
  openFile: async (filePath: string) => {
	...
	// const projectPath = getProjectPath();
  	// console.log("Rich Presence: " + "Editing " + tabName(filePath) + ", project: but with constant project placeholder instead " + (projectPath ? projectPath.split(/[\\/]/).pop() : undefined))
  	window.celestia.rich_presence.set("Editing " + tabName(filePath), undefined, "project here", undefined)
	if (existing) {
  ...
  closeTab: (id: string) => {
	...
	setActiveTab: (id: string) => {
		set({ activeTabId: id });
		// const projectPath = getProjectPath();
		// console.log("Rich Presence: " + "Editing " + tabName(id) + ", project: " + (projectPath ? projectPath.split(/[\\/]/).pop() : undefined))
		window.celestia.rich_presence.set("Editing " + tabName(id), undefined, "placeholder project")
	},
